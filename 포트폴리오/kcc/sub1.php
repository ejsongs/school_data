<?php
    ...
    include "db.php";
    $select = "select * from board ORDER BY idx DESC limit 0,10" ; 
    $rs = $pdo -> query($select); 
    $rs -> execute(); 
		...
		<div id="content">
			<div class="sub_con">
				<div class="left_con">
					...
					<li><a href="sub1.php" >자료실<span class="sp_sub select_ico"></span></a></li>
				...
				<div class="right_con">	
					...
					<tbody>
                       <?php
                        ...
                        <tr>
							<td>
								<div class="in"><?=$data['idx']?></div>
							</td>
							<td class="con">
								<div class="in"><a href="./view.php?idx=<?=$data['idx']?>"><?=$data['title']?></a></div>
							</td>
							<td>
								<div class="in">
									<div class="in"><?=$data['created_at']?></div>
								</div>
							</td>
							<td>
								<div class="in">
									<div class="in"><?=$data['hit']?></div>
								</div>
							</td>
                        </tr>
                        <?php
